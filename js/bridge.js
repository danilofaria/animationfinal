...
two_ds_scene = new TwoDScene(2);
two_ds_scene.setPosition(0, [0,0.6,0]);
two_ds_scene.radii[0]=1;
two_ds_scene.setM(0,1);
two_ds_scene.isFixed[0] = false;

two_ds_scene.setPosition(1, [0,-0.6,0]);
two_ds_scene.setVelocity(1, [0,0,0]);
two_ds_scene.radii[1]=1;
two_ds_scene.setM(1,1);
two_ds_scene.isFixed[1] = false;
var spring_force = new SpringForce([0,1], 1, 10, 0.);
two_ds_scene.insertForce(spring_force);

var edge_colors = []
two_ds_scene.insertEdge([0,1],0.1);
edge_colors.push(new THREE.Color( 1, 0, 10));
